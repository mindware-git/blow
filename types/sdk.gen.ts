 ...
 */
export const googleCallbackAuthCallbackGooglePost = <ThrowOnError extends boolean = false>(options: Options<GoogleCallbackAuthCallbackGooglePostData, ThrowOnError>) => (options.client ?? client).post<GoogleCallbackAuthCallbackGooglePostResponses, GoogleCallbackAuthCallbackGooglePostErrors, ThrowOnError>({ url: '/auth/callback/google', ...options });
 ...
 * Create Comment
 */
export const createCommentCommentsPost = <ThrowOnError extends boolean = false>(options: Options<CreateCommentCommentsPostData, ThrowOnError>) => (options.client ?? client).post<CreateCommentCommentsPostResponses, CreateCommentCommentsPostErrors, ThrowOnError>({
    url: '/comments/',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Delete Comment
 */
export const deleteCommentCommentsCommentIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteCommentCommentsCommentIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteCommentCommentsCommentIdDeleteResponses, DeleteCommentCommentsCommentIdDeleteErrors, ThrowOnError>({ url: '/comments/{comment_id}', ...options });

/**
 * Read Comment
 */
export const readCommentCommentsCommentIdGet = <ThrowOnError extends boolean = false>(options: Options<ReadCommentCommentsCommentIdGetData, ThrowOnError>) => (options.client ?? client).get<ReadCommentCommentsCommentIdGetResponses, ReadCommentCommentsCommentIdGetErrors, ThrowOnError>({ url: '/comments/{comment_id}', ...options });
